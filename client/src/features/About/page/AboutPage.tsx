...
const AboutPage = () => {
  return (
    <Layout>
      ...
      <section className='h-full md:mt-16 bg-gradient-to-r from-secondary to-accent lg:py-16'>
        <div className='flex flex-col items-center px-2 py-16 lg:flex lg:items-center lg:pt-8 gap-6'>
          ...
          <h3 className={`${styles.heading6} text-primary text-center font-headerText px-2 lg:pb-5`}>Nuestras Ideas</h3>
      ...
      <section className='flex flex-col justify-center items-center h-full py-20 lg:py-24 gap-6 mb-6 '>
        <h3 className={`${styles.heading6} text-secondary text-center font-headerText py-4 px-2 w-full`}>¿Te gustaria saber mas?</h3>
        <ContactForm/>
      </section>
