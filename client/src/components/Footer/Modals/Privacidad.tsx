...
const PrivacyPolicyModal = () => {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div className="fixed z-20 top-0 left-0 w-full h-full bg-black bg-opacity-50 flex items-center justify-center text-left ">
          <div ref={modalRef} className="bg-white p-8 max-w-xl md:max-w-3xl lg:max-w-4xl xl:max-w-5xl h-[650px] rounded-[24px] mt-8 mb-8">
            <div className="overflow-y-auto max-h-full">
              <div className='mr-6'>
                ...
                <h2 className="text-2xl mb-4 text-contrast font-bold text-headerText">Política de Privacidad y Términos de Uso</h2>
                ...
                <h3 className="text-xl mt-4 mb-2 text-contrast font-bold">¿Qué información recopilamos sobre ti y por qué?</h3>
                <p className="text-contrast">
                ...
                {showMore && (
                  <>
                    ...
                    <h3 className="text-xl mt-4 mb-2 text-contrast font-bold">¿Cómo compartimos tu información?</h3>
                    <p className="text-contrast">
                    ...
                    <h3 className="text-xl mt-4 mb-2 text-contrast font-bold">Nuestro uso de cookies y otros mecanismos de seguimiento</h3>
                    <p className="text-contrast">
                    ...
                    <h3 className="text-xl mt-4 mb-2 text-contrast font-bold">Enlaces de terceros</h3>
                    <p className="text-contrast">
                    ...
                    <h3 className="text-xl mt-4 mb-2 text-contrast font-bold">Comunicaciones de nosotras</h3>
                    <p className="text-contrast">
                    ...
                    <h3 className="text-xl mt-4 mb-2 text-contrast font-bold">Seguridad de tu información personal</h3>
                    <p className="text-contrast">
                    ...
                    <h3 className="text-xl mt-4 mb-2 text-contrast font-bold">Cambios a esta política</h3>
                    <p className="text-contrast">
                    ...
                    <h3 className="text-xl mt-4 mb-2 text-contrast font-bold">Contacto</h3>
                    <p className="text-contrast">
