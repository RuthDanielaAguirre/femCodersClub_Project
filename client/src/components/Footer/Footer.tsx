...
const FccFooter = () => {
  return (
    ...
    <Footer className='w-full h-[250px] bg-gradient-to-r from-primary mx-auto via-accent to-secondary text-primary rounded-none flex flex-end  bottom-0' >
      <div className="w-full h-full">
        <div className=" w-full mt-2 mx-auto px-4 py-4 justify-between sm:justify-between sm:flex sm:justify-between md:flex grid grid-cols-1 md:grid-cols-3 gap-4 container">
          ...
          <div className="mt-4 flex flex-col space-y-4 sm:mt-0 sm:justify-center text-tertiary">
            ...
            <div>
            <p className='text-primary'>O también:</p>
             <SlackButton />
            </div>
          </div>
          <div className="flex flex-col md:grid-cols-1 items-start">
            <CookiePolicyModal />
            <PrivacyPolicyModal />
            <p className='text-primary'>Apoya a FemCoders Club</p>
        ...
        <div className='w-full flex flex flex-col bg-gradient-to-r from-primary mx-auto via-accent to-secondary text-primary rounded-none border-t py-4'>
