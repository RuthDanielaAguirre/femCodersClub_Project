  ...
  return (
    ...
    <Footer className='w-full h-fit bg-gradient-to-r from-primary mx-auto via-accent to-secondary text-primary rounded-none flex flex-end  bottom-0 px-8' >
      <div className="w-full h-full mb-2 md:mb-6 md:mt-6">
        <div className=" w-full mt-2 mx-auto px-4 justify-between sm:justify-between sm:flex sm:justify-between md:flex grid grid-cols-1 md:grid-cols-3 sm:gap-4 gap-1 container">
          ...
          <div className="flex flex-col-reverse sm:flex-col text-align sm:items-end justify-center text-right mb-2">
            <div className="flex flex-row md:flex-col gap-1 border-t sm:border-none mt-2">
              <CookiePolicyModal />
              <PrivacyPolicyModal />
            </div>
