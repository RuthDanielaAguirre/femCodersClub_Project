...
export class EventbriteService {
  ...
  createEvent(createEventDto: CreateEventDto): Observable<any> {
    return this.httpService
      .post(`https://www.eventbriteapi.com/v3/organizations/2076189237573/events/`, createEventDto, {
        headers: {
  ...
  updateEvent(idEvent: number, updateEventDto: UpdateEventDto): Observable<any> {
    return this.httpService
      .post(`https://www.eventbriteapi.com/v3/events/${idEvent}`, updateEventDto, {
        headers: {
          Authorization: `Bearer DCSSDPUMSEBOT4WC5R2C`,
